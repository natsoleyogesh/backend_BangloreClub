...
const serviceAccount = require('./bangaloreclub-599ec-firebase-adminsdk-ojfrm-2a83482191.json');
...
//     try {
//         // Validate departmentId if department is not 'All'
//         if (department !== 'All' && !departmentId) {
...
//             const user = await User.findById(departmentId, 'fcmToken').exec();
//             if (user) allDeviceTokens.push(user.fcmToken);

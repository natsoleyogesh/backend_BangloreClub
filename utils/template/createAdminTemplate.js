module.exports = {
    subject: "Panel Login Credentials",
    body: `
       <!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <title>Panel Login Credentials - Bangalore Club</title>
    <style>
...
<body>
    <div class="email-container">
        <div class="header">
            <h1>Banglore Club Panel Credentials</h1>
        </div>
        <div class="content">
           ...
           <p>Please do not share your password for security reasons.</p>
            <div class="icons">

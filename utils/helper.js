...
// const generateMultipleUniqueQRCodes = async (members) => {
//     const qrCodes = [];
//     for (const member of members) {
...
//         const uniqueQRCodeData = `QR${uniqueNumber}`;
//         const uniqueId = uniqueQRCodeData;  // Unique identifier
//         const qrCode = await generateUniqueQRCode({ ...member, uniqueId });
//         qrCodes.push({
//             ...member,
//             uniqueQRCode: qrCode, // Add the generated unique QR code to the member object
//         });
//     }
//     return qrCodes;
// };
